...
public class ShopService {
 ...
 public List<Product> browse(String q,String cat,String type)throws Exception{return products.search(q,cat,type);}
 ...
 public long checkout(long user,String shippingName,String shippingAddress,String shippingPhone,String paymentMethod)throws Exception{List<CartItem> items=cart.find(user);if(items.isEmpty())throw new IllegalArgumentException("Your cart is empty.");long id=orders.place(user,items,shippingName,shippingAddress,shippingPhone,paymentMethod);cart.clear(user);return id;}
}
